...
\begin{abstract}
    \einfart{} is part of the \minimalist{} class series. The entire collection includes \minimart{} and \einfart{} for typesetting articles, and \minimbook{} and \simplivre{} for typesetting books. My original intention in designing them was to write drafts and notes that look simple but not shabby.
...
\einfart{} has some features of both the standard classes and the \AmS{} classes.
